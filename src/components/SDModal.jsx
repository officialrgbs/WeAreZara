...
function SDModal({isOpen, onClose, recap}) {
  ...
  return (
    <div id="modal-backdrop" onClick={handleBackgroundClick} className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm bg-black/40">
