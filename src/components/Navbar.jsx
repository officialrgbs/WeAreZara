...
function Navbar() {
  ...
  return (
    <nav className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white shadow-lg rounded-full px-6 py-3 border border-gray-300 flex gap-6 z-50">
      <Link to="/" className={`px-4 py-2 rounded-full transition-all duration-300 ease-in-out ${
          location.pathname === "/" ? "bg-gray-200 font-semibold" : "bg-transparent"
        }`}>Home</Link> 
      <Link to="/resources" className={`px-4 py-2 rounded-full transition-all duration-300 ease-in-out ${
        location.pathname === "/resources" ? "bg-gray-200 font-semibold" : "bg-transparent"
      }`}>Resources</Link>
      <Link to="/about" className={`px-4 py-2 rounded-full transition-all duration-300 ease-in-out ${
